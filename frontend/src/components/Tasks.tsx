        ...
        {showForm && (
          <form onSubmit={handleSubmit} style={{ marginTop: '20px' }}>
            <div className="form-group">
              <label htmlFor="tasks-title">Título:</label>
              <input
                id='tasks-title'
                type="text"
            ...
            <div className="form-group">
              <label htmlFor="tasks-description">Descrição:</label>
              <textarea
            ...
            <div className="form-group">
              <label htmlFor='tasks-priority'>Prioridade:</label>
              <select
                id='tasks-priority'
            ...
            <div className="form-group">
              <label htmlFor='tasks-user'>Usuário:</label>
              <select
                id='tasks-user'
            ...
            <div className="form-group">
              <label htmlFor='tasks-category'>Categoria:</label>
              <select
                id='tasks-category'
